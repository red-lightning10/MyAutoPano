...
def SetupAll(BasePath, CheckPointPath):
    ...
    """
    # Setup DirNames
    DirNamesTrain = "/home/adhi/YourDirectoryID_p1/Phase2/Data/Train"
    print(DirNamesTrain)
    # Read and Setup Labels
    LabelsPathTrain = 'h4t.csv'
...
def ReadLabels(LabelsPathTrain):
    if not (os.path.isfile(LabelsPathTrain)):
        ...
        TrainLabels = np.genfromtxt('h4t.csv', delimiter=',')
        x,y = np.shape(TrainLabels)
        TrainLabels = TrainLabels[1:x,1:y]
        print(TrainLabels)
    return TrainLabels
